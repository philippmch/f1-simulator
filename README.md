...
# dashboard shows scenario cards, top-N win chart/matrix controls, trend metric+scale controls, sortable/filterable/exportable matrix, quick links, quick example presets, rerun, run filtering, and persistent UI prefs
```
