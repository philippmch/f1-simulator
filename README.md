...
When exporting, `statistics.json` includes run metadata (`seed`, `parallel`, `max_workers`), team championship projection, plus top-3 and top-10 finish probabilities for richer race analysis.
