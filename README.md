...
# dashboard shows scenario cards, win chart, trend metric+scale controls, sortable/filterable matrix, quick links, presets, rerun, run filtering, and persistent UI prefs
```
